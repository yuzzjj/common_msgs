...
#ifndef GOOGLE_PROTOBUF_INCLUDED_openbot_5fbridge_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_openbot_5fbridge_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_openbot_5fbridge_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto
...
struct TableStruct_openbot_5fbridge_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_openbot_5fbridge_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::openbot_bridge::basic_msgs::VehicleSignal* Arena::CreateMaybeMessage<::openbot_bridge::basic_msgs::VehicleSignal>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace openbot_bridge {
namespace basic_msgs {
...
enum VehicleSignal_TurnSignal : int {
  ...
  VehicleSignal_TurnSignal_TURN_HAZARD_WARNING = 3,
  VehicleSignal_TurnSignal_VehicleSignal_TurnSignal_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  VehicleSignal_TurnSignal_VehicleSignal_TurnSignal_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
constexpr VehicleSignal_TurnSignal VehicleSignal_TurnSignal_TurnSignal_MAX = VehicleSignal_TurnSignal_TURN_HAZARD_WARNING;
...
class VehicleSignal PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:openbot_bridge.basic_msgs.VehicleSignal) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "openbot_bridge.basic_msgs.VehicleSignal";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_openbot_5fbridge_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  static constexpr TurnSignal TURN_HAZARD_WARNING =
  ...
  ::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal turn_signal() const;
  void set_turn_signal(::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal value);
  private:
  ::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal _internal_turn_signal() const;
  void _internal_set_turn_signal(::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:openbot_bridge.basic_msgs.VehicleSignal)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_openbot_5fbridge_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto;
};
// ===================================================================
...
inline ::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal VehicleSignal::_internal_turn_signal() const {
  return static_cast< ::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal >(turn_signal_);
}
inline ::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal VehicleSignal::turn_signal() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.basic_msgs.VehicleSignal.turn_signal)
  return _internal_turn_signal();
}
inline void VehicleSignal::_internal_set_turn_signal(::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal value) {
  
  turn_signal_ = value;
}
inline void VehicleSignal::set_turn_signal(::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal value) {
  _internal_set_turn_signal(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.basic_msgs.VehicleSignal.turn_signal)
}
...
inline bool VehicleSignal::high_beam() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.basic_msgs.VehicleSignal.high_beam)
...
inline void VehicleSignal::set_high_beam(bool value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.basic_msgs.VehicleSignal.high_beam)
}
...
inline bool VehicleSignal::low_beam() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.basic_msgs.VehicleSignal.low_beam)
...
inline void VehicleSignal::set_low_beam(bool value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.basic_msgs.VehicleSignal.low_beam)
}
...
inline bool VehicleSignal::horn() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.basic_msgs.VehicleSignal.horn)
...
inline void VehicleSignal::set_horn(bool value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.basic_msgs.VehicleSignal.horn)
}
...
inline bool VehicleSignal::emergency_light() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.basic_msgs.VehicleSignal.emergency_light)
...
inline void VehicleSignal::set_emergency_light(bool value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.basic_msgs.VehicleSignal.emergency_light)
}
...
template <> struct is_proto_enum< ::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal>() {
  return ::openbot_bridge::basic_msgs::VehicleSignal_TurnSignal_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_openbot_5fbridge_2fbasic_5fmsgs_2fvehicle_5fsignal_2eproto
