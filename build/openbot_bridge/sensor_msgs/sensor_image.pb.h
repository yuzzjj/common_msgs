...
#ifndef GOOGLE_PROTOBUF_INCLUDED_openbot_5fbridge_2fsensor_5fmsgs_2fsensor_5fimage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_openbot_5fbridge_2fsensor_5fmsgs_2fsensor_5fimage_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_openbot_5fbridge_2fsensor_5fmsgs_2fsensor_5fimage_2eproto
...
struct TableStruct_openbot_5fbridge_2fsensor_5fmsgs_2fsensor_5fimage_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_openbot_5fbridge_2fsensor_5fmsgs_2fsensor_5fimage_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::openbot_bridge::sensor_msgs::CompressedImage* Arena::CreateMaybeMessage<::openbot_bridge::sensor_msgs::CompressedImage>(Arena*);
template<> ::openbot_bridge::sensor_msgs::Image* Arena::CreateMaybeMessage<::openbot_bridge::sensor_msgs::Image>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace openbot_bridge {
namespace sensor_msgs {
...
constexpr PixelFormat PixelFormat_MIN = NONE;
...
class Image PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:openbot_bridge.sensor_msgs.Image) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "openbot_bridge.sensor_msgs.Image";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_openbot_5fbridge_2fsensor_5fmsgs_2fsensor_5fimage_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:openbot_bridge.sensor_msgs.Image)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_openbot_5fbridge_2fsensor_5fmsgs_2fsensor_5fimage_2eproto;
};
// -------------------------------------------------------------------

class CompressedImage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:openbot_bridge.sensor_msgs.CompressedImage) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "openbot_bridge.sensor_msgs.CompressedImage";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:openbot_bridge.sensor_msgs.CompressedImage)
 private:
  class _Internal;
...
inline const ::openbot_bridge::basic_msgs::Header& Image::_internal_header() const {
...
inline const ::openbot_bridge::basic_msgs::Header& Image::header() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.Image.header)
...
inline void Image::unsafe_arena_set_allocated_header(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:openbot_bridge.sensor_msgs.Image.header)
}
inline ::openbot_bridge::basic_msgs::Header* Image::release_header() {
...
inline ::openbot_bridge::basic_msgs::Header* Image::unsafe_arena_release_header() {
  // @@protoc_insertion_point(field_release:openbot_bridge.sensor_msgs.Image.header)
  
  ::openbot_bridge::basic_msgs::Header* temp = header_;
  header_ = nullptr;
  return temp;
}
inline ::openbot_bridge::basic_msgs::Header* Image::_internal_mutable_header() {
...
inline ::openbot_bridge::basic_msgs::Header* Image::mutable_header() {
  // @@protoc_insertion_point(field_mutable:openbot_bridge.sensor_msgs.Image.header)
  return _internal_mutable_header();
}
inline void Image::set_allocated_header(::openbot_bridge::basic_msgs::Header* header) {
  ...
  header_ = header;
  // @@protoc_insertion_point(field_set_allocated:openbot_bridge.sensor_msgs.Image.header)
}
...
inline const std::string& Image::frame_id() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.Image.frame_id)
  return _internal_frame_id();
}
inline void Image::set_frame_id(const std::string& value) {
  _internal_set_frame_id(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.Image.frame_id)
}
inline std::string* Image::mutable_frame_id() {
  // @@protoc_insertion_point(field_mutable:openbot_bridge.sensor_msgs.Image.frame_id)
...
inline void Image::set_frame_id(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:openbot_bridge.sensor_msgs.Image.frame_id)
}
inline void Image::set_frame_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:openbot_bridge.sensor_msgs.Image.frame_id)
}
inline void Image::set_frame_id(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:openbot_bridge.sensor_msgs.Image.frame_id)
}
...
inline std::string* Image::release_frame_id() {
  // @@protoc_insertion_point(field_release:openbot_bridge.sensor_msgs.Image.frame_id)
...
inline void Image::set_allocated_frame_id(std::string* frame_id) {
  ...
  frame_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), frame_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:openbot_bridge.sensor_msgs.Image.frame_id)
}
...
inline double Image::measurement_time() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.Image.measurement_time)
...
inline void Image::set_measurement_time(double value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.Image.measurement_time)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Image::height() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.Image.height)
...
inline void Image::set_height(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.Image.height)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Image::width() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.Image.width)
...
inline void Image::set_width(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.Image.width)
}
...
inline const std::string& Image::encoding() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.Image.encoding)
  return _internal_encoding();
}
inline void Image::set_encoding(const std::string& value) {
  _internal_set_encoding(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.Image.encoding)
}
inline std::string* Image::mutable_encoding() {
  // @@protoc_insertion_point(field_mutable:openbot_bridge.sensor_msgs.Image.encoding)
...
inline void Image::set_encoding(std::string&& value) {
  ...
  encoding_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:openbot_bridge.sensor_msgs.Image.encoding)
}
inline void Image::set_encoding(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:openbot_bridge.sensor_msgs.Image.encoding)
}
inline void Image::set_encoding(const char* value,
    size_t size) {
  ...
  encoding_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:openbot_bridge.sensor_msgs.Image.encoding)
}
...
inline std::string* Image::release_encoding() {
  // @@protoc_insertion_point(field_release:openbot_bridge.sensor_msgs.Image.encoding)
...
inline void Image::set_allocated_encoding(std::string* encoding) {
  ...
  encoding_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), encoding,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:openbot_bridge.sensor_msgs.Image.encoding)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Image::step() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.Image.step)
...
inline void Image::set_step(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.Image.step)
}
...
inline const std::string& Image::data() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.Image.data)
  return _internal_data();
}
inline void Image::set_data(const std::string& value) {
  _internal_set_data(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.Image.data)
}
inline std::string* Image::mutable_data() {
  // @@protoc_insertion_point(field_mutable:openbot_bridge.sensor_msgs.Image.data)
...
inline void Image::set_data(std::string&& value) {
  ...
  data_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:openbot_bridge.sensor_msgs.Image.data)
}
inline void Image::set_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:openbot_bridge.sensor_msgs.Image.data)
}
inline void Image::set_data(const void* value,
  ...
  data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:openbot_bridge.sensor_msgs.Image.data)
}
...
inline std::string* Image::release_data() {
  // @@protoc_insertion_point(field_release:openbot_bridge.sensor_msgs.Image.data)
...
inline void Image::set_allocated_data(std::string* data) {
  ...
  data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:openbot_bridge.sensor_msgs.Image.data)
}
...
inline const ::openbot_bridge::basic_msgs::Header& CompressedImage::_internal_header() const {
  const ::openbot_bridge::basic_msgs::Header* p = header_;
  return p != nullptr ? *p : reinterpret_cast<const ::openbot_bridge::basic_msgs::Header&>(
      ::openbot_bridge::basic_msgs::_Header_default_instance_);
}
inline const ::openbot_bridge::basic_msgs::Header& CompressedImage::header() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.CompressedImage.header)
  return _internal_header();
}
inline void CompressedImage::unsafe_arena_set_allocated_header(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:openbot_bridge.sensor_msgs.CompressedImage.header)
}
inline ::openbot_bridge::basic_msgs::Header* CompressedImage::release_header() {
...
inline ::openbot_bridge::basic_msgs::Header* CompressedImage::unsafe_arena_release_header() {
  // @@protoc_insertion_point(field_release:openbot_bridge.sensor_msgs.CompressedImage.header)
  
  ::openbot_bridge::basic_msgs::Header* temp = header_;
  header_ = nullptr;
  return temp;
}
inline ::openbot_bridge::basic_msgs::Header* CompressedImage::_internal_mutable_header() {
...
inline ::openbot_bridge::basic_msgs::Header* CompressedImage::mutable_header() {
  // @@protoc_insertion_point(field_mutable:openbot_bridge.sensor_msgs.CompressedImage.header)
  return _internal_mutable_header();
}
inline void CompressedImage::set_allocated_header(::openbot_bridge::basic_msgs::Header* header) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(header_);
  }
  ...
  header_ = header;
  // @@protoc_insertion_point(field_set_allocated:openbot_bridge.sensor_msgs.CompressedImage.header)
}
...
inline const std::string& CompressedImage::frame_id() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.CompressedImage.frame_id)
  return _internal_frame_id();
}
inline void CompressedImage::set_frame_id(const std::string& value) {
  _internal_set_frame_id(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.CompressedImage.frame_id)
}
inline std::string* CompressedImage::mutable_frame_id() {
  // @@protoc_insertion_point(field_mutable:openbot_bridge.sensor_msgs.CompressedImage.frame_id)
  return _internal_mutable_frame_id();
}
...
inline void CompressedImage::set_frame_id(std::string&& value) {
  ...
  frame_id_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:openbot_bridge.sensor_msgs.CompressedImage.frame_id)
}
inline void CompressedImage::set_frame_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  frame_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:openbot_bridge.sensor_msgs.CompressedImage.frame_id)
}
inline void CompressedImage::set_frame_id(const char* value,
    size_t size) {
  ...
  frame_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:openbot_bridge.sensor_msgs.CompressedImage.frame_id)
}
...
inline std::string* CompressedImage::release_frame_id() {
  // @@protoc_insertion_point(field_release:openbot_bridge.sensor_msgs.CompressedImage.frame_id)
  return frame_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void CompressedImage::set_allocated_frame_id(std::string* frame_id) {
  ...
  frame_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), frame_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:openbot_bridge.sensor_msgs.CompressedImage.frame_id)
}
...
inline const std::string& CompressedImage::format() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.CompressedImage.format)
  return _internal_format();
}
inline void CompressedImage::set_format(const std::string& value) {
  _internal_set_format(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.CompressedImage.format)
}
inline std::string* CompressedImage::mutable_format() {
  // @@protoc_insertion_point(field_mutable:openbot_bridge.sensor_msgs.CompressedImage.format)
...
inline void CompressedImage::set_format(std::string&& value) {
  ...
  format_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:openbot_bridge.sensor_msgs.CompressedImage.format)
}
inline void CompressedImage::set_format(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:openbot_bridge.sensor_msgs.CompressedImage.format)
}
inline void CompressedImage::set_format(const char* value,
    size_t size) {
  ...
  format_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:openbot_bridge.sensor_msgs.CompressedImage.format)
}
...
inline std::string* CompressedImage::release_format() {
  // @@protoc_insertion_point(field_release:openbot_bridge.sensor_msgs.CompressedImage.format)
...
inline void CompressedImage::set_allocated_format(std::string* format) {
  ...
  format_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), format,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:openbot_bridge.sensor_msgs.CompressedImage.format)
}
...
inline const std::string& CompressedImage::data() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.CompressedImage.data)
  return _internal_data();
}
inline void CompressedImage::set_data(const std::string& value) {
  _internal_set_data(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.CompressedImage.data)
}
inline std::string* CompressedImage::mutable_data() {
  // @@protoc_insertion_point(field_mutable:openbot_bridge.sensor_msgs.CompressedImage.data)
  return _internal_mutable_data();
}
...
inline void CompressedImage::set_data(std::string&& value) {
  ...
  data_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:openbot_bridge.sensor_msgs.CompressedImage.data)
}
inline void CompressedImage::set_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:openbot_bridge.sensor_msgs.CompressedImage.data)
}
inline void CompressedImage::set_data(const void* value,
  ...
  data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:openbot_bridge.sensor_msgs.CompressedImage.data)
}
...
inline std::string* CompressedImage::release_data() {
  // @@protoc_insertion_point(field_release:openbot_bridge.sensor_msgs.CompressedImage.data)
  return data_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void CompressedImage::set_allocated_data(std::string* data) {
  ...
  data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:openbot_bridge.sensor_msgs.CompressedImage.data)
}
...
inline double CompressedImage::measurement_time() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.CompressedImage.measurement_time)
  return _internal_measurement_time();
}
...
inline void CompressedImage::set_measurement_time(double value) {
  _internal_set_measurement_time(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.CompressedImage.measurement_time)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 CompressedImage::frame_type() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.CompressedImage.frame_type)
...
inline void CompressedImage::set_frame_type(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.CompressedImage.frame_type)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 CompressedImage::width() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.CompressedImage.width)
  return _internal_width();
}
...
inline void CompressedImage::set_width(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_width(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.CompressedImage.width)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 CompressedImage::height() const {
  // @@protoc_insertion_point(field_get:openbot_bridge.sensor_msgs.CompressedImage.height)
  return _internal_height();
}
...
inline void CompressedImage::set_height(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_height(value);
  // @@protoc_insertion_point(field_set:openbot_bridge.sensor_msgs.CompressedImage.height)
}
...
template <> struct is_proto_enum< ::openbot_bridge::sensor_msgs::PixelFormat> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::openbot_bridge::sensor_msgs::PixelFormat>() {
  return ::openbot_bridge::sensor_msgs::PixelFormat_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_openbot_5fbridge_2fsensor_5fmsgs_2fsensor_5fimage_2eproto
